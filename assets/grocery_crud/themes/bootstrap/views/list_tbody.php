...
<?php foreach($list as $num_row => $row){ ?>
    <tr>
        <td <?php if ($unset_delete) { ?> style="border-right: none;"<?php } ?>
            <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?> width="30px">
            <?php if (!$unset_delete) { ?>
        ...
        <td <?php if ($unset_delete) { ?> style="border-left: none;"<?php } ?>
            <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?>  width="100px">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    ?>
                                        <?php if(!$unset_edit){?>
                                        <li>
                                            <a class="" href="<?php echo $row->edit_url?>"><i class="fa fa-pencil"></i> <?php echo $this->l('list_edit'); ?></a>
                                        </li>
                    <?php } ?>
                                    <?php if (!$unset_read) { ?>
                                        <li>
